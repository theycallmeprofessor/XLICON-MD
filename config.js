...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://theycallmeprofessormirza:<db_password>@cluster0.dhr58.mongodb.net/?retryWrites=true&w=majority"
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? "MIRZA" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'MIRZA' : process.env.OWNER_NAME,  
